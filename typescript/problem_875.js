function minEatingSpeed(piles, h) {
    ...
    var biggestPile = piles[piles.length - 1];
    var left = 0;
    ...
    while (getTime(piles, middle - 1) === h) {
        middle -= 1;
    }
    return middle;
}
;
function getTime(sortedPiles, speed) {
    var time = 0;
    for (var _i = 0, sortedPiles_1 = sortedPiles; _i < sortedPiles_1.length; _i++) {
        var pile = sortedPiles_1[_i];
